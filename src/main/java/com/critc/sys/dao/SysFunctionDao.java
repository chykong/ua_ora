...
public class SysFunctionDao extends BaseDao {
    ...
    public int add(SysFunction sysFunction) {
        String sql = "insert into t_sys_function(id,module_id,name,code,url,type,description,display_order) values(seq_t_sys_function.nextval,:module_id,:name,:code,:url,:type,:description,:display_order)";
