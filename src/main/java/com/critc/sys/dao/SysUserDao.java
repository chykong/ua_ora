...
public class SysUserDao extends BaseDao {
    ...
    public int add(SysUser sysUser) {
        ...
        int rc = getNamedParameterJdbcTemplate().update(sql, new BeanPropertySqlParameterSource(sysUser), keyHolder, new String[] { "id" });
        if (rc > 0) {
    ...
    public List<SysUser> list(SysUserSearchVO sysUserSearchVO) {
        ...
        sql += " order by id asc";
        sql = PageUtil.createOraclePageSQL(sql, sysUserSearchVO.getPageIndex(), sysUserSearchVO.getPageSize());
